...
C {lab_wire.sym} -270 480 0 1 {name=VCM1 sig_type=std_logic lab=VCM}
...
C {pseudo_res_c.sym} 400 590 2 1 {name=x_rpseudo_fb}
C {lab_wire.sym} 440 590 0 1 {name=OTA_INN2 sig_type=std_logic lab=OTA_INN}
C {lab_wire.sym} 440 570 3 1 {name=VOUT2 sig_type=std_logic lab=VOUT}
C {lab_wire.sym} 440 610 0 1 {name=VDPWR4 sig_type=std_logic lab=VDPWR}
C {lab_wire.sym} 190 360 0 0 {name=BIAS_P sig_type=std_logic lab=BIAS_P}
